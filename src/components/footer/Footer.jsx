        ...
        <div className="col-md-6">
          <div className="footer-section">
            ...
            <a href="#" className="social-link">
              <FontAwesomeIcon icon={faFacebook} className="social-icon mr-3" size="2x" />
              <span className="social-name">Facebook</span>
            </a>
            <a href="#" className="social-link">
              <FontAwesomeIcon icon={faTwitter} className="social-icon mr-3" size="2x" />
              <span className="social-name">Twitter</span>
            </a>
            <a href="#" className="social-link">
              <FontAwesomeIcon icon={faInstagram} className="social-icon mr-3" size="2x" />
